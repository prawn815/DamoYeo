         ...
         <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
               <div class="page-heading">
                  <h1>정보 게시판</h1>
                  <span class="subheading">자전거 도로</span>
               </div>
            </div>
         </div>
      </div>
...
<div class="container" style="font-family: 맑은 고딕;">
         ...
         <div class="option">
            <div>
               <form onsubmit="searchPlaces(); return false;">
                  키워드 : <input type="text" value="자전거도로" id="keyword" size="15">
   ...
   <!-- <a href="controller.do?command=selectINFOBOARD&page=1&boardno=3">1</a>
   <a href="controller.do?command=selectINFOBOARD&page=2&boardno=3">2</a>
   <a href="controller.do?command=selectINFOBOARD&page=3&boardno=3">3</a>
    -->
   
   <div align="center">
      <input type="button" class="button2" value="1" onclick="location.href='controller.do?command=selectINFOBOARD&page=1&boardno=3'"/>
      <input type="button" class="button2" value="2" onclick="location.href='controller.do?command=selectINFOBOARD&page=2&boardno=3'"/>
      <input type="button" class="button2" value="3" onclick="location.href='controller.do?command=selectINFOBOARD&page=3&boardno=3'"/>
