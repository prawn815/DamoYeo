...
<%
   List<InfoBoardDto> list = (List<InfoBoardDto>)request.getAttribute("list");
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="container" style="font-family: 맑은 고딕;">
         ...
         <div class="option">
            <div>
               <form onsubmit="searchPlaces(); return false;">
                  ...
                  <button type="submit" style="font-family: 맑은 고딕;" class="button1">검색하기</button>
   ...
   <br />
   <div align="center">
      <input type="button" style="font-family: 맑은 고딕;" class="button" value="따릉이"  onclick="location.href='controller.do?command=selectINFOBOARD&page=1&boardno=1'" />
      <input type="button" style="font-family: 맑은 고딕;" class="button" value="헬스장"  onclick="location.href='controller.do?command=selectINFOBOARD&page=1&boardno=2'" />
      <input type="button" style="font-family: 맑은 고딕;" class="button" value="자전거 도로"  onclick="location.href='controller.do?command=selectINFOBOARD&page=1&boardno=3'" />
   </div>
   
   <br />
   <table border="1" class="table" style="font-family: 맑은 고딕;">
      <col width="50px">
      <col width="100px">
      <col width="200px">
      <col width="300px">
      ...
      <tr>
         ...
         <td><a href="controller.do?command=selectAbout&myno=<%=list.get(i).getMyno() %>"><%=list.get(i).getMycontent()%></a></td>
      </tr>
   ...
   <!-- <a href="controller.do?command=selectINFOBOARD&page=1&boardno=2">1</a>
   <a href="controller.do?command=selectINFOBOARD&page=2&boardno=2">2</a>
   <a href="controller.do?command=selectINFOBOARD&page=3&boardno=2">3</a>
   <a href="controller.do?command=selectINFOBOARD&page=4&boardno=2">4</a> -->
   
   
   <div align="center">
      <input type="button" class="button2" value="1" onclick="location.href='controller.do?command=selectINFOBOARD&page=1&boardno=2'"/>
      <input type="button" class="button2" value="2" onclick="location.href='controller.do?command=selectINFOBOARD&page=2&boardno=2'"/>
      <input type="button" class="button2" value="3" onclick="location.href='controller.do?command=selectINFOBOARD&page=3&boardno=2'"/>
      <input type="button" class="button2" value="4" onclick="location.href='controller.do?command=selectINFOBOARD&page=4&boardno=2'"/>
