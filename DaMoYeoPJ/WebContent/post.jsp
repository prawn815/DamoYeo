	...
	<script type="text/javascript">
		...
		window.onload=function(){
			...
			for(var i=0; i < size/10; i++){
				taga.innerHTML += " <a href='controller.do?command=selectList&page="+ (i+1) +"')>"+ (i+1)+ "</a> ";
			}
		};
...
%>
				...
				<div id="paging">
					<%
						if(pagecnt != 1){
					%>
					<a href="controller.do?command=selectList&page=<%=pagecnt-1%>" id="pre">이전</a>
					<%
						}
						else{
					%>
					...
					%>
					<a href="controller.do?command=selectList&page=<%=pagecnt+1%>" id="next">다음</a>
					<%
				...
				<div id="searchtxt" align="center">
					<form action="controller.do" method="post">
						<input type="hidden" name="command" class="button" value="searchResult" />
