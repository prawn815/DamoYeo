...
<title>다이어트필요한사람모두여기로!</title>
   ...
   <%
      ProductDto prodto = (ProductDto)request.getAttribute("prodto");
...
//             });
      ...
      IMP.request_pay({
         ...
         if(rsp.success){
            ...
            alert(msg);
            location.href="controller.do?command=saleOne&my_id="+my_id+"&addr="+addr+"&pid="+pid;
         }else{
            var msg ='결제에 실패하였습니다.';
...
%>
    ...
    <!-- Main Content -->
      ...
      <table class="table" border="1" summary="주문 리스트">
         ...
         <tbody>
            ...
            <tr id="<%=prodto.getPid() %>" >
               <td class="order_thmb"><a><img alt="<%=prodto.getPname() %>" src="img/product/do<%=prodto.getPid()%>.jpg"width="100" height="100"></a>
               </td>
               <td colspan="3"><a class="order_deal" title=""> </a>
                  <p class="p_info"><%=prodto.getPname() %></p>
                     <span class="order_option_cnt"> 
                        <span class="order_option_cnt_input"><%=amount %></span>&nbsp; &nbsp; 
                        <span class="order_option_price"><em class="b"><%=price %></em>원 </span>
                     </span>       
               </td>
            </tr>
      ...
      <table class="table" border="1" summary="정보">
         ...
         <tbody>
            <tr>
               <th>보내는분</th>
               <td>
                  <input name="sdname" id="sdname" class="order_txt order_dimmed placeholder" type="text" style="width: 130px" placeholder="보내는분 입력">
               </td>
            </tr>
            <tr class="last">
               <th>연락처</th>
               <td align="left">
                  <div class="order_select_box" style="margin-left: inherit" >
                     <select class="order_select" style="width: 60px;" name="stel1" id="sdtel1" >
                  ...
                  &nbsp;-&nbsp; 
                  <input class="order_txt order_dimmed" type="tel" style="width: 110px" name="stel2" id="sdtel2" value="" maxlength="4">&nbsp;-&nbsp; 
                  <input class="order_txt order_dimmed" type="tel" style="width: 110px" name="stel3" id="sdtel3" value="" maxlength="4">
                  </div>
               </td>
            </tr>
         </tbody>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><!-- style="width: 130px" -->
                  ...
                  <input type="text" name="postnum" class="postcodify postcode mini" id="sample6_postcode" placeholder="우편번호" disabled="disabled"/><input type="button" onclick="sample6_execDaumPostcode()" class="button" value="우편번호 찾기"><br>
            ...
            <tr>
               ...
               <td>
                  <div class="order_select_box" style="margin-left: inherit" >
                     <select class="order_select" style="width: 60px" name="tel11"
                        id="tel11" data-oval="" >
                        <option value="010">010</option>
                        <option value="011">011</option>
                        <option value="016">016</option>
                     ...
                     &nbsp;-&nbsp; 
                  <input class="order_txt order_dimmed" style="width: 110px" type="tel" name="tel12" id="tel12" value="" maxlength="4" data-oval="">
                  &nbsp;-&nbsp; 
                  <input class="order_txt order_dimmed" style="width: 110px" type="tel" name="tel13" id="tel13" value="" maxlength="4" data-oval="">                  
                  </div>
               </td>
            </tr>
         </tbody>
   ...
   <script type="text/javascript"> // 여기임에 총 결제금액 넣기
      $("#tprc").text(<%=price %>+Number($("#totaldeliveryfee").text()));
   </script>
   <div class="order_detail mt80" >
      <!-- 주문 정보 -->
